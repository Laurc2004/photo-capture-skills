...
[![ClawHub](https://img.shields.io/badge/ClawHub-photo--capture-blue.svg)](https://clawhub.ai)
...
This will automatically download and install the skill to your skills directory.

### Option 2: Manual Installation

1. Clone or download this repository
2. Copy the `photo-capture` folder to your skills directory:
   - OpenClaw: `~/.openclaw/workspace/skills/`
   - Generic: `~/.agents/skills/`

```bash
git clone https://github.com/Laurc2004/photo-capture-skills.git
cp -r photo-capture-skills/photo-capture ~/.agents/skills/
```
...
这将自动下载并安装技能到你的 skills 目录。

### 方式 2：手动安装

1. 克隆或下载本仓库
2. 将 `photo-capture` 文件夹复制到你的 skills 目录：
   - OpenClaw: `~/.openclaw/workspace/skills/`
   - 通用: `~/.agents/skills/`
